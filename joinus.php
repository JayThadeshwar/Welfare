    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href=<?php echo JOIN_US; ?> class="nav-link">Join Us</a></li>
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-3 align-items-stretch">
              <div class="text">
                ...
                <p><a href=<?php echo VOLUNTEER_SIGNUP; ?> class="btn btn-white px-3 py-2 mt-2">Be A Volunteer</a></p>
                <p><a href=<?php echo VOLUNTEER_LOGIN; ?> class="btn btn-white px-3 py-2 mt-2">Volunter Login</a></p>
              </div>
            </div>
          </div>
        </div>
