      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Select Disaster Type...</h1>
          
              <a href=<?php echo NATURAL_DISASTER; ?>>
                <div class="col-lg-6 d-flex mb-sm-6 ftco-animate text-center" style="height:200px;">
                    <div class="staff">
                        <div class="d-flex mb-6">
                            <div class="img" style="background-image: url(images/nd.jpg);"></div>
                            <br>
                            NATURAL DISASTER&nbsp;&nbsp;&nbsp;
                        </div>
                    </div>
                ...
                <a href=<?php echo MANMADE_DISASTER; ?>>
                <div class="col-lg-6 d-flex mb-sm-6 ftco-animate text-center" style="height:200px;">
                    <div class="staff">
                        <div class="d-flex mb-6">
                            <div class="d-flex mb-6">
                            <div class="img" style="background-image: url(images/md.jpg);"></div>
                            <br>
                            MAN-MADE DISASTER
                        </div>
                        </div>
